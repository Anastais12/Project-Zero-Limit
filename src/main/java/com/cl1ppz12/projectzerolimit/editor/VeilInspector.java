...
public class VeilInspector extends SingleWindowInspector {

    public static final MutableText TITLE = Text.translatable("editor.veil-example-mod.inspector.title");
