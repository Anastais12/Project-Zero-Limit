...
public class ChainsOfTheJudge extends Ability {

    public ChainsOfTheJudge(String id, Text name, Text description, Identifier texture, AbilityType type, float damage, int auraCost, int cooldownTicks) {
        super(id, name, description, texture, type, damage, auraCost, cooldownTicks);
    }

    @Override
    public Identifier getIconTexture() {
        return Identifier.of("project_zero_limit", "textures/ability/oni_art/chains_of_the_judge.png");
    }
